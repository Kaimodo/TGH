# Run this in an administrative PowerShell prompt to install the TGH PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://www.github.com/Kaimodo/TGH/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'TGH'
$DownloadURL = 'https://www.github.com/Kaimodo/TGH/raw/master/release/TGH-current.zip'
