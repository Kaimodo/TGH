...
function Get-ADComputerByUser {
    ...
    .LINK
        https://www.github.com/Kaimodo/TGH/tree/master/release/0.0.1/docs/Functions/Get-ADComputerByUser.md
    #>
...
function Get-Decryption {
    ...
    .EXTERNALHELP TGH-help.xml
    .LINK
        https://www.github.com/Kaimodo/TGH/tree/master/release/0.0.1/docs/Functions/Get-Encryption.md
    #>
    ...
    process {
        ...
        try {
            ...
            Write-Host "$($FunctionName): An Error occured"
        }
    }
...
function Get-PubIP {
    ...
    .EXTERNALHELP TGH-help.xml
    .LINK
        https://www.github.com/Kaimodo/TGH/tree/master/release/0.0.1/docs/Functions/Get-PubIP.md
    #>
...
function Set-Encryption {
    ...
    .EXTERNALHELP TGH-help.xml
    .LINK
        https://www.github.com/Kaimodo/TGH/tree/master/release/0.0.1/docs/Functions/Set-Encryption.md
    #>
