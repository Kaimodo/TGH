...
FunctionsToExport = 'Convert-PS2Bat', 'Convert-txt2wav', 'Get-ADComputerByUser', 
               'Get-Decryption', 'Get-GitSheet', 'Get-HelpMessage', 'Get-PubIP', 
               'Get-WindowsProductKey', 'New-Speak', 'New-SS', 'Open-Autostart', 
               'Open-Desktop', 'Open-Doc', 'Open-Home', 'Open-OneDrive', 'Search-Google', 
               'Set-Encryption', 'Show-CliTool', 'Show-Fish'
